...
export default function ProductList({ products = [], countPerRow = 3, customer_id, customer_email, addClickViewApi }) {
          ...
          coreComponents={[
            {
              ...
              props: { url: p.url, imageUrl: get(p, 'image.url'), alt: p.name, product_id: p.productId, url_key: p.urlKey, customer_id, customer_email, addClickViewApi},
              sortOrder: 10,
              id: 'thumbnail'
            },
            {
              component: { default: Name },
              props: { name: p.name, url: p.url, product_id: p.productId, url_key: p.urlKey, customer_id, customer_email, addClickViewApi},
              sortOrder: 20,
              id: 'name'
            },
            {
